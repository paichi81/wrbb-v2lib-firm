...
mrb_value mrb_rtc_mktime(mrb_state *mrb, mrb_value self)
{
  mrb_value value;
...
void rtc_Init(mrb_state *mrb)
{
	...
	// 81 modified
	mrb_define_module_function(mrb, rtcModule, "mktime", mrb_rtc_setTime, MRB_ARGS_REQ(6));
	mrb_define_module_function(mrb, rtcModule, "now", mrb_rtc_getTime, MRB_ARGS_NONE());
